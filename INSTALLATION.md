...
<a style="color: white;" href="https://github.com/dateName/Raven-Storm/blob/master/INSTALLATION.md#lazy-installer">高级</a> - <a style="color: white;" href="https://github.com/dateName/Raven-Storm/blob/master/INSTALLATION.md#or-start-your-unix-terminal-and-type-in-following">专家</a> - <a style="color: white;" href="https://github.com/dateName/Raven-Storm/blob/master/INSTALLATION.md#other-operating-systems">其他操作系统</a> - <a style="color: white;" href="https://github.com/dateName/Raven-Storm/blob/master/INSTALLATION.md#uninstall">卸载</a>
...
```git clone https://github.com/dateName/Raven-Storm/```
